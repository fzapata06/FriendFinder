...
exports.assignAlias = (autoAlias, token, deployment, apiUrl, debug) => __async(function*(){
  ...
  // Assign alias
  yield aliases.set(String(deployment), String(autoAlias));
}());

exports.reAlias = (token, host, help, exit, apiUrl, debug, alias) => __async(function*(){
